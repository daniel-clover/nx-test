...
function createProjectFileMapCache(nxJson, packageJsonDeps, projectFileMap, tsConfig) {
    var _a;
    const nxJsonPlugins = ((nxJson === null || nxJson === void 0 ? void 0 : nxJson.plugins) || []).map((p) => ({
        name: p,
    ...
    const newValue = {
        ...
        nxJsonPlugins,
        pluginsConfig: nxJson === null || nxJson === void 0 ? void 0 : nxJson.pluginsConfig,
        projectFileMap,
    };
    return newValue;
}
...
function shouldRecomputeWholeGraph(cache, packageJsonDeps, projects, nxJson, tsConfig) {
    ...
    if (((nxJson === null || nxJson === void 0 ? void 0 : nxJson.plugins) || []).length !== cache.nxJsonPlugins.length)
        return true;
    // a plugin has changed
    if (((nxJson === null || nxJson === void 0 ? void 0 : nxJson.plugins) || []).some((t) => {
    ...
    if (JSON.stringify(nxJson === null || nxJson === void 0 ? void 0 : nxJson.pluginsConfig) !==
