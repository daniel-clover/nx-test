...
function buildProjectGraphUsingContext(nxJson, knownExternalNodes, ctx, cachedFileData, projectGraphVersion) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, build_nodes_1.normalizeProjectNodes)(ctx, builder, nxJson);
...
function updateProjectGraphWithPlugins(context, initProjectGraph) {
    var _a;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const plugins = yield (0, nx_plugin_1.loadNxPlugins)((_a = context.nxJsonConfiguration) === null || _a === void 0 ? void 0 : _a.plugins);
        ...
        for (const plugin of plugins) {
            try {
                if ((0, nx_plugin_1.isNxPluginV2)(plugin) && plugin.createDependencies) {
                    ...
                    const newDependencies = yield plugin.createDependencies(Object.assign(Object.assign({}, context), { graph }));
